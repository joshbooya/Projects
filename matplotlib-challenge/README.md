PYBER 3 Observable Trends:

1. Percentage of Rides from Urban City Types are the highest compared to Suburban and Rural rides. 
2. The percentage of drivers and revenue from fares is proportionate to the large percentage of rides by each city type. In other words, Urban has the largest # of rides and so the largest portion of revenue and drivers are from this city type. The 2nd largest # of rides is Suburban and it too has the 2nd largest revenue stream and number of drivers by city type.
3. The average price of Urban fares is much lower then Suburban & Rural fares. 
4. Average fare by city type is inversely proportionate to the percentage of total fares by city type.
...
* Average Fare ($) Per City - DONE
* Total Number of Rides Per City - DONE
* Total Number of Drivers Per City - DONE
* City Type (Urban, Suburban, Rural) - DONE

In addition, you will be expected to produce the following three pie charts:

* % of Total Fares by City Type - DONE
* % of Total Rides by City Type - DONE
* % of Total Drivers by City Type - DONE

As final considerations:

* You must use the Pandas Library and the Jupyter Notebook. - DONE
* You must use the Matplotlib and Seaborn libraries. - DONE
* You must include a written description of three observable trends based on the data.
* You must use proper labeling of your plots, including aspects like: Plot Titles, Axes Labels, Legend Labels, Wedge Percentages, and Wedge Labels.- DONE
* Remember when making your plots to consider aesthetics! - DONE
  * You must stick to the Pyber color scheme (Gold, Light Sky Blue, and Light Coral) in producing your plot and pie charts. - DONE
  * When making your Bubble Plot, experiment with effects like `alpha`, `edgecolor`, and `linewidths`. - DONE
  * When making your Pie Chart, experiment with effects like `shadow`, `startangle`, and `explosion`. - DONE
* You must include an exported markdown version of your Notebook called  `README.md` in your GitHub repository. - DONE
