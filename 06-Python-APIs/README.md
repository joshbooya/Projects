...
* Temperature (F) vs. Latitude - DONE
* Humidity (%) vs. Latitude - DONE
* Cloudiness (%) vs. Latitude - DONE
* Wind Speed (mph) vs. Latitude - DONE
...
* Include a print log of each city as it's being processed with the city number, city name, and requested URL. - DONE
* Save both a CSV of all data retrieved and png images for each scatter plot. - DONE

As final considerations:

* You must use the Matplotlib and Seaborn libraries. - DONE
* You must include a written description of three observable trends based on the data. - DONE
